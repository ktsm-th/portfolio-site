    ...
    <main>
      ...
      <div className="flex flex-col lg:flex-row justify-center mt-8 mb-8">
        ...
        <div className=" mx-8 lg:w-96 lg:ml-8 mt-4 lg:mt-0">
          ...
          <div>
            <p className="mt-8 tracking-wide">A Software Developer and Textile Design graduate with skills in both and front-end and back-end development (React/Next.js, Laravel). Eager to start a career within the tech industry to expand my skillset within a professional environment.</p>
