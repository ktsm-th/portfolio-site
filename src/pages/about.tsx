    ...
    <main>
      <div className="flex justify-center mt-8 mb-8">
        ...
        <div className="w-96 ml-8">
          ...
          <p className="mt-8">A soon-to-be Textile Design graduate who has been working on     expanding development skills alongside their studies, a focus on Javascript alongside rest APIs and frameworks. Driven and eager for self improvement, as well as the development of skills through the support of a team, while also expanding the ability to troubleshoot and solve issues independently. Hoping to start a career within the software development industry, particularly within tech for good.</p>
        </div>
      </div>
          ...
          <form action="/send-data-here" method="post">
            ...
            <div className="w-1/2 mr-1">
              <label className="font-bold text-l" for="first">First name:</label>
                  <input  className="w-auto" type="text" id="first" name="first" />
            </div>
            <div className="w-1/2 ml-1">
              <label className="font-bold text-l" for="last">Last name:</label>
                <input className="w-full" type="text" id="last" name="last" />
                </div>
            </div>
            <div className="mt-4">
              <label className="font-bold text-l" for="email">Email:</label>
                <input className="w-full" type="text" id="email" name="email" />
            </div>
            <div className="mt-4">
          ...
          <ul className="mt-8">
            ...
            <Link className="flex" href="https://www.instagram.com/ktsm.thbcu/">
              <Image
                ...
                className=""
                />
                <li className="ml-2 font-">/ktsm.thbcu</li>
                </Link>
            </div>
            <div className="flex items-center mt-3">
              <Image
                ...
                className=""
                />
                <li className="ml-2 font-">katie.whatever@whateverdomain.i.get</li>
            </div>
          </ul>
        </div>
      </div>
