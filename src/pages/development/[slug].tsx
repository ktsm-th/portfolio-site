      ...
      <div className="flex flex-col mx-4 lg:mx-0 lg:flex-row justify-center mt-8 mb-8">
        ...
        <div className="flex flex-col items-center lg:block w-96 lg:ml-4">
          ...
          {project.repository_link.length > 0 || project.live_link.length > 0 ? (
            <div className="inline-flex items-center justify-center w-full mt-12 lg:mt-24">
          ...
          {project.repository_link.length > 0 ? (
            <div className="flex justify-start lg:items-center mt-4 hover:opacity-20">
              <Link className="flex" href={project.repository_link}>
                <Image
                  ...
                  className="h-8 w-8"
                />
                <li className="list-none ml-2 mt-1">{project.repository_link}</li>
              </Link>
            </div>) : (
              <div></div>
          )}
            ...
            <div className="flex justify-start lg:items-center mt-4 hover:opacity-20">
              <Link className="flex" href={project.live_link}>
                <Image
                  ...
                  alt="live link"
                />
                <li className="list-none ml-2 mt-1">{project.live_link}</li>
              </Link>
            </div>) : (
              <div></div>
            )}
